...
public class OutlineScript : MonoBehaviour
{
    ...
    void Update()
    {
        OutlineColor.r = Mathf.Clamp(map(distance, 2, 0, 0, 255), 0, 255);
        OutlineColor.g = Mathf.Clamp(map(distance, 2, 0, 0, 255), 0, 255);
        OutlineColor.b = Mathf.Clamp(map(distance, 2, 0, 0, 255), 0, 255);
        OutlineColor.a = Mathf.Clamp(map(distance, 2, 0, 0, 255), 0, 255);
        ...
        outline.SetFloat("Vector1_e2aa71b3209842c5a6eb0b87444d3361", Mathf.Clamp01(map(distance, 0.2f, 1, 0.07f, 0)));
